...
final class UnconfiguredGoogleCloudStorageClient implements GoogleCloudStorageClient {
    ...
    private StorageException unconfigured() {
        return new StorageException("Google Cloud Storage client is not configured");
    }
}
