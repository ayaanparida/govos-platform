...
final class UnconfiguredAzureBlobStorageClient implements AzureBlobStorageClient {
    ...
    private StorageException unconfigured() {
        return new StorageException("Azure Blob storage client is not configured");
    }
}
